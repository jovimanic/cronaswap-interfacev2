...
import { BlocksIcon, TelegramIcon, TokenomicsIcon, TwitterIcon } from 'app/components/Icon'
    ...
    <div className="flex flex-row justify-between gap-4">
      <div className="bg-dark-900 rounded w-full">
        ...
        >
          ...
          <div
            className="flex flex-col px-4 pt-8 space-y-8 rounded-r bg-dark-800"
            {...{
              style: {
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-4 items-center pb-4">
                ...
                <a href={getExplorerLink(chainId, ifo.address, 'address')} target="_blank" rel="noreferrer">
