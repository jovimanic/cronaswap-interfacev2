import { AbstractCurrency, Binance, ChainId, Currency, CurrencyAmount, Ether, Token } from '@cronaswap/core-sdk'
  ...
  useEffect(() => {
    ...
    if (currency.isNative) {
      ...
      if (!contractAddr) {
        ...
        } else if (chainTo.id == ChainId.ETHEREUM && currency.symbol == 'ETH') {
