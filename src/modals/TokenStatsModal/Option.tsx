...
export default function Option({
  ...
  const content = (
    <div
      ...
      className={`flex items-center justify-between w-full p-3 rounded cursor-pointer ${
        !active ? 'bg-dark-800 hover:bg-dark-900' : 'bg-dark-1000'
      }`}
    >
      <div>
  ...
  return !active ? content : <div className="w-full p-px rounded bg-gradient-to-r from-yellow to-yellow">{content}</div>
}
