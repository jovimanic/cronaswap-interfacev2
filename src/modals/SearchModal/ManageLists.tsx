  ...
  return (
    <div style={{ height: `${height}px` }} className="flex flex-col space-y-4">
      <input
        ...
        className="mt-4 w-full bg-dark-900 border border-dark-800 focus:border-transparent focus:border-gradient-r-blue-red-dark-900 rounded placeholder-secondary focus:placeholder-primary font-bold text-base px-6 py-3.5 appearance-none"
        value={listUrlInput}
