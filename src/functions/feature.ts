...
const features = {
  ...
  [ChainId.CRONOS]: [Feature.AMM, Feature.LIQUIDITY_MINING, Feature.ZAP, Feature.BENTOBOX, Feature.KASHI, Feature.MIGRATE, Feature.ANALYTICS, Feature.STAKING, Feature.MISO],
}
