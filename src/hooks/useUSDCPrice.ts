import { ChainId, Currency, CurrencyAmount, Price, Token, USD } from '@cronaswap/core-sdk'

import { useActiveWeb3React } from '../services/web3'
import { useMemo } from 'react'
import { useV2TradeExactOut } from './useV2Trades'
import { useDashboardV1Contract } from './useContract'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [ChainId.CRONOS]: CurrencyAmount.fromRawAmount(USD[ChainId.CRONOS], 100_000e6),
}
