import { ChainId, Ether, SUSHI_ADDRESS, Token, WETH9, WNATIVE } from '@cronaswap/core-sdk'
...
export const SUSHI: ChainTokenMap = {
  ...
  [ChainId.CRONOS]: new Token(ChainId.CRONOS, SUSHI_ADDRESS[ChainId.CRONOS], 18, 'CRONA', 'CronaSwap'),
  [ChainId.CRONOS_TESTNET]: new Token(ChainId.CRONOS_TESTNET, SUSHI_ADDRESS[ChainId.CRONOS_TESTNET], 18, 'CRONA', 'CronaSwap'),
}
