...
import { ChainId, Currency, Token, WNATIVE } from '@cronaswap/core-sdk'
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.CRONOS]: [...WRAPPED_NATIVE_ONLY[ChainId.CRONOS], CRONOS.DAI, CRONOS.USDC, CRONOS.USDT, CRONOS.WBTC, CRONOS.WETH],
}
...
export const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.CRONOS]: [...WRAPPED_NATIVE_ONLY[ChainId.CRONOS], CRONOS.USDC, CRONOS.WBTC, CRONOS.DAI, CRONOS.WETH, CRONOS.USDT, SUSHI[ChainId.CRONOS]],
