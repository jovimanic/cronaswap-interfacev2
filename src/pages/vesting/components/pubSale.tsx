...
import { usePubSaleContract, useSeedSaleContract } from 'hooks/useContract'
import { usePurchased, useClaimable, useClaimed } from '../hooks/usePublicSaleInfo'

export const PublicSaleVesting = () => {
