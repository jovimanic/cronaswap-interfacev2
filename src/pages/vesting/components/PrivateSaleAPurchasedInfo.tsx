...
import { usePurchased, useClaimable } from '../hooks/usePrivateSaleAInfo'
...
const PreSaleInfo = () => {
  ...
  const cronaAmountToDisplay = hasFetchedCronaAmount ? getBalanceNumber(userPurchased, 18) : 0
