            ...
            <div className="col-span-12 lg:col-span-8 h-full" style={{ minHeight: '40rem' }}>
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="p-8 pb-4 rounded-lg bg-dark-900">
                  ...
                  <p className="text-sm mb-8 text-dm-text-secondary">
                    CRONA Boost is your opportunity to increase the power and rewards of your CRONA. The longer you lock
                    your CRONA the greater your voting power (CRONA Power) and weekly reward share will be. You can
                    boost up to 4x by locking CRONA for 4 years. Your boosts slowly reduces over your locking period,
                    eventually unlocking your CRONA, however you can always increase your boost to maintain your boosted
                    level. Your boosted CRONA is represented in eCRONA (escrowed CRONA) and will remain in escrow until
                    your unlock date (non-transferable).
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 auto-cols-max">
                  <div className="p-4 rounded-lg bg-dark-800">
                    ...
                    <h2 className="text-sm flex flex-row items-center">
                      veCRONA APY <QuestionHelper text="Average CRONA lock time in veCRONA." />
                    </h2>
                  </div>
                  <div className="p-4 rounded-lg bg-dark-800">
                    <h1 className="text-lg">
                ...
                {/* <div class="grid grid-cols-1 md:grid-cols-3 gap-4 auto-cols-max">
                  <div class="p-8 rounded-lg bg-dm-secondary">
                  <h1 class="text-lg">Next blocks</h1>
                  <p class="text-lg text-dm-text-secondary">24349818 to 24637818</p>
                  <span class="flex flex-row items-center text-sm mt-1">Qualified</span></div>
                  <div class="p-8 rounded-lg bg-dm-secondary"><h1 class="text-lg">Current blocks</h1><p class="text-lg text-dm-text-secondary">24074909 to 24349818</p><span class="flex flex-row items-center text-sm mt-1 invisible"><svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-1 text-red"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>Not Qualified</span></div><div class="p-8 rounded-lg bg-dm-secondary"><h1 class="text-lg">Previous blocks</h1><p class="text-lg text-dm-text-secondary"> 23800000 to 24074909</p><span class="flex flex-row items-center text-sm mt-1 invisible"><svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mr-1 text-red"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>Not Qualified</span></div></div> */}
                {/* lock crona */}
